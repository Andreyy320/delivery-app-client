...
class OdejdaMenuScreen extends StatefulWidget {
  final String restaurantName;
  final String shopId;


  const OdejdaMenuScreen({
    super.key,
  ...
  @override
  State<OdejdaMenuScreen> createState() => _OdejdaMenuScreenState();
}

class _OdejdaMenuScreenState extends State<OdejdaMenuScreen> {
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (context, i) => ClothingCardWithStatus(
...
/// Стилизованная карточка товара одежды
class ClothingCardWithStatus extends StatefulWidget {
  final Dish dish;
  final String shopId;
  const ClothingCardWithStatus(
      {required this.dish, required this.shopId, super.key});

  @override
  State<ClothingCardWithStatus> createState() => _ClothingCardWithStatusState();
}

class _ClothingCardWithStatusState extends State<ClothingCardWithStatus> {
  bool _pressed = false;
  ...
  Widget build(BuildContext context) {
    ...
    // Форматирование размера/характеристики для одежды
    String getSubtitleText() {
      if (widget.dish.weight.isNotEmpty) {
        return "Размер: ${widget.dish.weight}";
      }
      return "";
    }
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          getSubtitleText(),
                          style: const TextStyle(
                            color: Color(0xFFA855F7), // Акцентный фиолетовый для одежды
                            fontSize: 11,
                            fontWeight: FontWeight.w800,
                          ),
                        ),
...
Widget PositionByRelative(String count) {
  return Positioned(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFA855F7), // Сочный фиолетовый акцент для одежды
