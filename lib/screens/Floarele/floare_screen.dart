                    ...
                    onPressed: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) => CartScreen(
                          ...
                          restaurantName: widget.shopName,
                        ),
                      ),
                    ),
                  ),
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: 'Найдите букет или цветы...',
                      hintStyle:
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (context, i) => FlowerCardWithStatus(
...
/// Стилизованная карточка цветов / букета
class FlowerCardWithStatus extends StatefulWidget {
  final Dish dish;
  final String shopId;
  const FlowerCardWithStatus({
    required this.dish,
    required this.shopId,
    super.key,
  });
  ...
  @override
  State<FlowerCardWithStatus> createState() => _FlowerCardWithStatusState();
}

class _FlowerCardWithStatusState extends State<FlowerCardWithStatus> {
  bool _pressed = false;
  ...
  Widget build(BuildContext context) {
    ...
    String getUnit(String category) {
      ...
      if (cat.contains('поштучно') || cat.contains('розы') || cat.contains('цветы')) {
        return "шт";
      } else if (cat.contains('стебли')) {
        return "ст";
      }
      return "букет";
    }
