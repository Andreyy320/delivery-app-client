                      ...
                      children: [
                        ...
                        GridView.builder(
                          ...
                          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                            crossAxisCount: 2,
                            childAspectRatio: 0.52, // Соотношение для фиксации высоты
                            crossAxisSpacing: 16,
                            mainAxisSpacing: 16,
                          ),
...
class DishCardWithStatus extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String getUnit(String category) {
      ...
      if (cat.contains('напитки') || cat.contains('сок') || cat.contains('beverages')) return "мл";
      return "г";
    }
          ...
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        Positioned.fill(
                          child: Image.network(
                            dish.imagePath,
                            fit: BoxFit.cover,
                            errorBuilder: (c, e, s) => const Icon(Icons.shopping_bag_outlined, color: Colors.grey, size: 40),
                          ),
                        ),
                        Positioned(
                          top: 8, right: 8,
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    // Название (фиксированно 2 строки)
                    SizedBox(
                      height: 38,
                      child: Text(
                          dish.name,
                    ...
                    // Описание (фиксированно 3 строки)
                    SizedBox(
                      height: 40,
                      child: Text(
                          dish.description,
