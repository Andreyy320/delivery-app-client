...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MejCityCargoDetailsScreen(),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        // Белые иконки на оранжевом фоне смотрятся чище
        iconTheme: const IconThemeData(color: Colors.black),
        title: SizedBox(
          width: MediaQuery.of(context).size.width * 0.7,
          child: const FittedBox(
            fit: BoxFit.scaleDown, // 👈 Теперь заголовок точно влезет на твой Samsung
            child: Text(
      ...
      body: Column(
        children: [
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  _containerBlock(
                    child: Column(
                      ...
                      children: [
                        ...
                        // Блок времени (сделали более интерактивным)
                        InkWell(
                  ...
                  // Добавили немного места снизу, чтобы скролл не перекрывался панелью
                  const SizedBox(height: 20),
                ],
              ),
            ),
          ...
          // ======= ЕДИНАЯ ПАНЕЛЬ СТОИМОСТИ И КНОПКИ =======
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  width: double.infinity,
                  height: 60, // Наша стандартная высота кнопки
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(16),
                    boxShadow: [
                      BoxShadow(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        iconTheme: const IconThemeData(color: Colors.black), // Белая стрелочка назад
      ),
      body: Stack(
        children: [
          // 1. КАРТА
                  ...
                  markers: [
                    Marker(
                      ...
                      child: const Icon(
                        ...
                        color: Colors.red,
                        size: 50,
                        // Добавим небольшое свечение маркеру, чтобы его было лучше видно
          ...
          // 2. ПОДСКАЗКА СВЕРХУ (если адрес еще не выбран)
          if (selectedLatLng == null)
            Positioned(
              top: 20,
              left: 40,
          ...
          // 3. ТА САМАЯ ПРЕМИАЛЬНАЯ КНОПКА (появляется после тапа)
          if (selectedLatLng != null)
            Positioned(
