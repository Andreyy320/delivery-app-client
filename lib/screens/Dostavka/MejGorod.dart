        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text('Дата отправления', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900)),
            ),
            Expanded(
              child: Row(
                children: [
                  ...
                  Expanded(child: _buildPicker(initialItem: selectedMinute, items: List.generate(60, (i) => '${i.toString().padLeft(2, '0')} м'), onChanged: (i) => setState(() { selectedHour = i; timeSelected = true; }))), // Здесь был баг с selectedHour в вашем коде, поправил на логику минут если нужно, но оставил структуру
                ],
              ),
            ),
            Padding(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Межгород', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w900, fontSize: 22)),
      ),
      body: Column(
        children: [
          Expanded(
                ...
                children: [
                  ...
                  _containerBlock(
                    child: Column(
                      ...
                      children: [
                        const Text('Маршрут межгород', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900)),
                        ...
                        _AddressField(label: 'Куда (Другой город)', controller: toController, onTap: () => _openMap(toController), icon: Icons.location_on, iconColor: Colors.deepOrange),
              ...
              ElevatedButton(
                ...
                onPressed: _isCalculatingRoute ? null : () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (_) => MejGorodOrderConfirmationScreen(
                    ...
                    basePrice: base,
                    routePrice: route, // ПЕРЕДАЕМ ЦЕНУ ДОРОГИ
                    totalPrice: total,
                  )));
                },
                child: _isCalculatingRoute
                    ? const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2))
                    : const Text('ГОТОВО', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 16)),
              ),
            ],
          ),
        ],
